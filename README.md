...
Along the way I've been first responder to CodeRed, Nimda, Sasser and SQL Slammer events, performed continuous threat monitoring, managed a 'secret' cerified PKI, and picked up some skills/knowledge along the way: CISSP, SABSA Chartered Practitioner (Security Architecture), SABSA Chartered Foundation, Certificate of Cloud Security Knowledge (CSA), PCI Internal Security Assessor, and a stack of SANS/GIAC certifications (GCIA Gold with Honours, GCFW Gold, GSNA Gold, GAWN, and GSPA).
